...
<html>
    ...
    <body>
        ...
        <!-- Comments marked with a ##Number## are your tasks to complete. 
        DO NOT DELETE THESE COMMENTS, PUT YOUR CODE UNDER THESE COMMENTS.  
        I can mark it faster that way. -->
        ...
        <div class="score">
            ...
            <div>Computer: <!-- ## 7 ## -->
                ...
                <?php if(isset($_SESSION["compScore"])) {
            ...
            <div>Player: <!-- ## 8 ## -->
                ...
                <!-- Output user's score -->
                <?php if(isset($_SESSION["userScore"])) {
